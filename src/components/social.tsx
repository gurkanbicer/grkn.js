...
function SocialItem({ icon, link }: { icon: IconProp; link: string | undefined }) {
...
export default function Social() {
  return (
    <>
      <SocialItem 
        icon={faDev} 
        link={process.env.NEXT_PUBLIC_SOCIAL_DEVTO}
      />
      <SocialItem 
        icon={faGit} 
      ...
      />
      <SocialItem icon={faSkype} link={process.env.NEXT_PUBLIC_SOCIAL_SKYPE} />
      <SocialItem
        icon={faTwitter}
